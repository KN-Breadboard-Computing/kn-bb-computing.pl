import { bitCell, andGate, connectNodeToNode, processCircuit } from "../sim.js";
...
function draw() {
  const canvas = document.getElementById("and_example");
  const container = document.getElementById("and_example_wrapper");
  if (canvas.getContext) {
    ...
    const buttonInputA = document.getElementById("and_example_input_a");
    ...
    const buttonInputB = document.getElementById("and_example_input_b");
