import { bitCell, orGate, connectNodeToNode, processCircuit } from "../sim.js";
...
function draw() {
  const canvas = document.getElementById("or_example");
  const container = document.getElementById("or_example_wrapper");
  if (canvas.getContext) {
    ...
    const buttonInputA = document.getElementById("or_example_input_a");
    ...
    const buttonInputB = document.getElementById("or_example_input_b");
